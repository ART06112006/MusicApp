...
{
    public class UserChangeProfileCommand : BaseCommand
    {
        ...
        public override bool CanExecute(object parameter)
        {
            ...
            {
                ViewModel = parameter as UserProfileViewModel;
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                MessageBox.Show("User profile was not updated!", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
}
